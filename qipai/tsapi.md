...
### 获取所有角色 <a id="/manager/GetRoles"></a>

**路径**
- POST `/manager/GetRoles`

**请求**
```ts
interface ReqGetRoles {
    /** 鉴权token，登录后的接口都需要填写 */
    __authToken?: string,
    /** 用户uid，仅服务器使用不需要填写 */
    __uid?: number,
...
### 设置角色 <a id="/manager/SetRole"></a>

**路径**
- POST `/manager/SetRole`
